...
public class EcouteurListeProduits implements Initializable {
    ...
    @FXML
    private TableColumn<Produit, String> colTitre;
    @FXML
    private TableColumn<Produit, Integer> colStock;
    @FXML
    private TableColumn<Produit, Float> colTarif;
    //
    @FXML
    ...
    @FXML
    private JFXTextField stockProduit;
    @FXML
    private JFXTextField tarifProduit;
    @FXML
    private ImageView image;
    @FXML
    private JFXComboBox<String> anneeSortie;
    @FXML
    private JFXComboBox<String> langueDictionnaire;
    @FXML
    private JFXTextField dureeSupportN;
    @FXML
    private JFXTextField nbPagesDocument;
    @FXML
    private JFXComboBox<String> realDVD;
    @FXML
    private JFXComboBox<String> auteurLivre;
    //
    ...
    private boolean champsNonVide()
    {
        ...
        if (langueDictionnaire.isVisible())
            b1 = b1 && (langueDictionnaire.getSelectionModel().getSelectedIndex() != -1);
